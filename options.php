	...
	<div id="wordphonic" class="wrap">
		...
		<div id="ephonic-options">
			<fieldset class="options"><legend>E-Phonic MP3 Player Options</legend>
				...
				<div class="submit"><input type="submit" name="submit" value="<?php _e('Update Options »'); ?>" /></div>
		...
		<div id="ephonic-playlist">
			...
			<?php wp_nonce_field('update-options'); ?>
			<input type="hidden" name="action" value="update" />
			<input type="hidden" name="page_options" value="t1,t2,t3,t4,t5,t6,t7,t8,t9,t10,register_update" />
			
			<fieldset class="options"><legend>The Playlist</legend>
				<p>Add your tracks.</p>
				<div class="submit"><input type="submit" name="submit" value="<?php _e('Update Playlist »'); ?>" /></div>
				...
				<tr>
					...
					<td class="artist"><input type="text" name="t<?php echo $i; ?>[artist]" value="<?php echo $track['artist']; ?>" /></td>
					<td class="title"><input type="text" name="t<?php echo $i; ?>[title]" value="<?php echo $track['title']; ?>" /></td>
					<td class="mp3"><input type="text" name="t<?php echo $i; ?>[file]" value="<?php echo $track['file']; ?>" /></td>
					<td class="image"><input type="text" name="t<?php echo $i; ?>[image]" value="<?php echo $track['image']; ?>" /></td>
				</tr>
				<?php } ?>
				</table>
				<div class="submit"><input type="submit" name="submit" value="<?php _e('Update Playlist »'); ?>" /></div>
